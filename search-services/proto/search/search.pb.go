...
const file_proto_search_search_proto_rawDesc = "" +
	"\n" +
	"\x19proto/search/search.proto\x12\x06search\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"=\n" +
...
var file_proto_search_search_proto_goTypes = []any{
	...
	(*Comic)(nil),                 // 2: search.Comic
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),         // 4: google.protobuf.Empty
}
var file_proto_search_search_proto_depIdxs = []int32{
	2, // 0: search.SearchReply.comics:type_name -> search.Comic
	3, // 1: search.Comic.date:type_name -> google.protobuf.Timestamp
	4, // 2: search.Search.Ping:input_type -> google.protobuf.Empty
	0, // 3: search.Search.Search:input_type -> search.SearchRequest
	0, // 4: search.Search.SearchIndex:input_type -> search.SearchRequest
	4, // 5: search.Search.Ping:output_type -> google.protobuf.Empty
	1, // 6: search.Search.Search:output_type -> search.SearchReply
	1, // 7: search.Search.SearchIndex:output_type -> search.SearchReply
