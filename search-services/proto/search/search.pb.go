...
const file_proto_search_search_proto_rawDesc = "" +
	...
	"\vSearchReply\x12%\n" +
	"\x06comics\x18\x01 \x03(\v2\r.search.ComicR\x06comics\")\n" +
	"\x05Comic\x12\x0e\n" +
...
var file_proto_search_search_proto_depIdxs = []int32{
	...
	1, // 5: search.Search.Search:output_type -> search.SearchReply
	1, // 6: search.Search.SearchIndex:output_type -> search.SearchReply
